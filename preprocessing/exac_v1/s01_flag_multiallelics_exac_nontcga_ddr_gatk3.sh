#!/bin/bash
# s01_flag_multiallelics_exac_nontcga_ddr_gatk3.sh

# Started: Alexey Larionov 15Mar2018
# Last updated: David Gilfoyle 01Apr2018

# Use:
# ./s01_flag_multiallelics_exac_nontcga_ddr_gatk3.sh &> s01_flag_multiallelics_exac_nontcga_ddr_gatk3.log

# Flagging of Multiallelic Variants in DNA Repair Genes from ExAC release 1 (nonTCGA subset) 
...
# Start message
echo "Started s01_flag_multiallelics_exac_nontcga_ddr_gatk3.sh"
date
echo ""
...
ddr_or_exac_ma_vcf="${base_folder}/results/preprocessed/exac_v1/s01_ddr_exac_nontcga_ma.vcf"
ddr_or_exac_ma_log="${base_folder}/results/preprocessed/exac_v1/s01_ddr_exac_nontcga_ma.log"

# "fma" for "flag multi-alelic"
ddr_or_exac_fma_vcf="${base_folder}/results/preprocessed/exac_v1/s01_ddr_exac_nontcga_fma.vcf"
ddr_or_exac_fma_log="${base_folder}/results/preprocessed/exac_v1/s01_ddr_exac_nontcga_fma.log"
...
# Completion mesage
echo ""
echo "Completed s01_flag_multiallelics_gatk3.sh"
date
