---
title: "r01_variant_filt_analysis_kgen_ddr"
...
output_folder="/home/ec2-user/results/data_analysis/variant_analysis/kgen/ddr"
...
ggplot(csq_counts.df, aes(csq_type, csq_count)) +
       ...
       geom_text(aes(label=format(csq_count, big.mark=","), vjust=-1), size=3) +
