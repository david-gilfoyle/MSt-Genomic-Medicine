#!/bin/bash
# s01_split_multiallelics_exac_or_bcftools.sh

# Started: Alexey Larionov 18Mar2018
# Last updated: David Gilfoyle 01Apr2018

# Use:
# ./s01_split_multiallelics_exac_or_bcftools.sh &> s01_split_multiallelics_exac_or_bcftools.log

# Splitting Multiallelic Variants in Olfactory Receptor Genes from ExAC release 1 (full dataset) 
...
# Start message
echo "Started s01_split_multiallelics_exac_or_bcftools.sh"
date
echo ""
...
fma_vcf="${base_folder}/results/preprocessed/exac_v1/s01_or_exac_fma.vcf"

clean_vcf="${base_folder}/results/preprocessed/exac_v1/s01_or_exac_clean.vcf"
split_vcf="${base_folder}/results/preprocessed/exac_v1/s01_or_exac_split.vcf"
...
# Completion mesage
echo ""
echo "Completed s01_split_multiallelics_exac_or_bcftools.sh"
date
