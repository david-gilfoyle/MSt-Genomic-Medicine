...
Variant filtering of AF filtered dataset to select missense (Consequence, SIFT [deleterious] and PolyPhen [likely_damaging]), high confidence (HC) missense (missense variants with FATHMM < -1.5 and CADD_PHRED > 10) and HC missense variants in genes with pLI >= 0.9  
Dataset: ExAC (full)  
