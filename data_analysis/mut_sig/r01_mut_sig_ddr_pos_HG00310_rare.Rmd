---
title: "r01_mut_sig_ddr_pos_HG00310_rare"
...
(high-confidence LoF variants) against control individuals - rare variants (AF<=0.01)
...
# Set sample name
sample_name <- c("HG00310_rare variants")
...
# Filter AF <= 0.01
rare_fixed.df <- all_fixed.df %>% 
  filter(as.numeric(EUR_AF) <= 0.01)

# Check AF
rare_fixed.df[1:10,1:20]
rare_fixed.df$EUR_AF[1:10]
...
required_fixed.df <- rare_fixed.df[,c("CHROM", "POS", "REF", "ALT")]
...
save.image("~/results/data_analysis/mut_sig/r01_mut_sig_ddr_pos_HG00310_rare.Rdata")
