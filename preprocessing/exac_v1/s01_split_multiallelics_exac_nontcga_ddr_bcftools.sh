#!/bin/bash
# s01_split_multiallelics_exac_nontcga_ddr_bcftools.sh

# Started: Alexey Larionov 18Mar2018
# Last updated: David Gilfoyle 01Apr2018

# Use:
# ./s01_split_multiallelics_exac_nontcga_ddr_bcftools.sh &> s01_split_multiallelics_exac_nontcga_ddr_bcftools.log

# Splitting Multiallelic Variants in DNA Repair Genes from ExAC release 1 (nonTCGA subset) 
...
# Start message
echo "Started s01_split_multiallelics_exac_nontcga_ddr_bcftools.sh"
date
echo ""
...
fma_vcf="${base_folder}/results/preprocessed/exac_v1/s01_ddr_exac_nontcga_fma.vcf"

clean_vcf="${base_folder}/results/preprocessed/exac_v1/s01_ddr_exac_nontcga_clean.vcf"
split_vcf="${base_folder}/results/preprocessed/exac_v1/s01_ddr_exac_nontcga_split.vcf"
...
# Completion mesage
echo ""
echo "Completed s01_split_multiallelics_exac_nontcga_ddr_bcftools.sh"
date
