...
dim(gq_icr1000_or.mx)
class(gq_icr1000_or.mx)
gq_icr1000_or.mx[1:5,1:5]
...
sum(rownames(gq_icr1000_or.mx) != rownames(fixed_icr1000_or.df)) # should be 0
...
gq_qfilt_icr1000_or.mx <- gq_icr1000_or.mx[rownames(fixed_qfilt_icr1000_or.df),]

# Compare filtered fixed column dataframe and GQ matrix
fixed_qfilt_icr1000_or.df[1:20,1:10]
gq_qfilt_icr1000_or.mx[1:20,1:5]

# Clean up
rm(gt_icr1000_or.mx, gq_icr1000_or.mx)
