...
# s01_preprocessing_qc_exac_nontcga_or.sh
# ExAC Non-TCGA (Olfactory Receptor Genes) Preprocessed File Quality Control

# Created: David Gilfoyle 22 Apr 2018
# Last Updated: David Gilfoyle 22 Apr 2018

# Use:
# ./s01_preprocessing_qc_exac_nontcga_or.sh &> s01_preprocessing_qc_exac_nontcga_or.log

# Stop at runtime errors
set -e

# Start message
echo "Starting Preprocessed ExAC Non-TCGA File Quality Control (Olfactory Receptor Genes)"
date
echo ""

# Tools, resources, files
base_folder="/home/ec2-user"
raw_file="${base_folder}/results/preprocessed/exac_v1/s01_or_exac_nontcga_raw.vcf"
ma_file="${base_folder}/results/preprocessed/exac_v1/s01_or_exac_nontcga_ma.vcf"
fma_file="${base_folder}/results/preprocessed/exac_v1/s01_or_exac_nontcga_fma.vcf"
clean_file="${base_folder}/results/preprocessed/exac_v1/s01_or_exac_nontcga_clean.vcf"
split_file="${base_folder}/results/preprocessed/exac_v1/s01_or_exac_nontcga_split.vcf"

vcf_stats_folder="${base_folder}/results/preprocessed/vcf_stats/exac_nontcga_or/"
vcf_stats2="${base_folder}/results/preprocessed/vcf_stats/exac_nontcga_or/exac_nontcga_or_split_vcfstats.txt"
...
# End message
echo "Finishing Preprocessed ExAC Non-TCGA File Quality Control (Olfactory Receptor Genes)"
date
echo ""
