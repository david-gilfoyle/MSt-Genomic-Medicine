...
Variant filtering of AF filtered dataset to select non-coding (Consequence) and high confidence (HC) non-coding (FATHMM_MKL_NC > 0.5 and CADD_PHRED > 20)   
...
# Clean-up
rm(input.df, output.df, output_hc.df, input.mx, output.mx, output_hc.mx, or_genes, removed_variant.df)
