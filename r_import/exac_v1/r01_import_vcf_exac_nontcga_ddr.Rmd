---
title: "r01_import_vcf_exac_nontcga_ddr"
...
vcf_file <- paste(input_folder,"s01_ddr_exac_nontcga_vep_annotated.vcf",sep="/")
...
fixed_exac_nontcga_ddr.df <- as.data.frame(meta_fix$fix)
...
fixed_exac_nontcga_ddr.df <- separate_(fixed_exac_nontcga_ddr.df, "CSQ", vep_fields, sep="\\|") 
...
NA -> fixed_exac_nontcga_ddr.df[fixed_exac_nontcga_ddr.df == ""]
dim(fixed_exac_nontcga_ddr.df)
fixed_exac_nontcga_ddr.df[1:20,140:145]
...
save.image(paste(output_folder, "r01_import_vcf_exac_nontcga_ddr.RData", sep="/"))
