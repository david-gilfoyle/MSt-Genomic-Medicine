---
title: "r01_mut_sig_ddr_neg_HG02981_common"
...
Individual: HG02981 (ESN) - Control
...
# Set sample name
sample_name <- c("HG02981_common variants")

# Set and load working VCF file
vcf_file="~/results/data_analysis/gt_individuals/kgen/ddr_control/HG02981/s01_HG02981_ddr_control_kgen_merged_raw.vcf.gz"
...
# Check dataframe
dim(required_fixed.df)   # 4,232,601 x 5
...
# Check dataframe
dim(required_fixed.df) # 3,698,822 x 5
...
save.image("~/results/data_analysis/mut_sig/r01_mut_sig_ddr_neg_HG02981_common.Rdata")
