#!/bin/bash
# s01_select_HG00365_ddr_positive_kgen.sh
...
# Selection of DDR Positive 'Test' Individual (HG00365; FIN (EUR)) from 1000 Genome Project (Genotype VCF Files)
