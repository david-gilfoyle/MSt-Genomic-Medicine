---
title: "r01_mut_sig_discord_HG00179-HG00351"
...
Individual: Present in HG00179 (FIN; DDR-) but not in HG00351 (FIN; DDR-)  
...
# Set sample name
sample_name <- c("HG00179-HG00351")

# Set and load working VCF file
vcf_file="~/results/data_analysis/gt_individuals/kgen/discordant/s01_HG00179-HG00351_discordant.vcf"
...
# Check dataframe
dim(required_fixed.df)   # 1,382,342 x 5
...
# Check dataframe
dim(required_fixed.df) # 1,216,446 x 5
...
save.image("~/results/data_analysis/mut_sig/r01_mut_sig_discord_HG00179-HG00310.Rdata")
