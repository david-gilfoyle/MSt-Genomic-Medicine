---
title: "r01_af_filtering_exac_nontcga_ddr"
...
input.df <- fixed_qfilt_exac_nontcga_ddr.df
...
fixed_af_filt_exac_nontcga_ddr.df <- output.df
...
save.image(paste(output_folder, "r01_exac_nontcga_ddr_af_filtered.RData", sep="/"))
