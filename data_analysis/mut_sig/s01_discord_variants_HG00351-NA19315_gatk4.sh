#!/bin/bash
# s01_discord_variants_HG00351-NA19315_gatk4.sh

# Started: David Gilfoyle 04Jul2018
# Last updated: David Gilfoyle 04Jul2018

# Use:
# ./s01_discord_variants_HG00351-NA19315_gatk4.sh &> s01_discord_variants_HG00351-NA19315_gatk4.log

# Selection of Discoradant Variants from 1000 Genome Project Individuals HG00351 (FIN; DDR-) and NA19315 (LWK; DDR-)
# Selected variants are present in Individual HG00351 but not in NA19315 
...
# Start message
echo "Started s01_discord_variants_HG00351-NA19315_gatk4.sh"
date
echo ""
...
output_vcf="${base_folder}/results/data_analysis/gt_individuals/kgen/discordant/s01_HG00351-NA19315_discordant.vcf"
output_log="${base_folder}/results/data_analysis/gt_individuals/kgen/discordant/s01_HG00351-NA19315_discordant.log"
...
# Completion mesage
echo ""
echo "Completed s01_discord_variants_HG00351-NA19315_gatk4.sh"
date
