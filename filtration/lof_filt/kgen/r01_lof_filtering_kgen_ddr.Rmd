---
title: "r01_lof_filtering_kgen_ddr"
...
output_hc_pli.df[1:5,1:10]
output_hc_pli.df$Consequence[1:5]
output_hc_pli.df$CADD_PHRED[1:5]
output_hc_pli.df$LoF[1:5]
output_hc_pli.df$ExACpLI[1:5]
...
# Compare filtered fixed column dataframe and genotype matrix
output_hc_pli.df[1:5,1:5]
output_hc_pli.mx[1:5,1:2]
...
fixed_lof_filt_kgen_ddr.df <- output.df
fixed_lof_hc_filt_kgen_ddr.df <- output_hc.df
fixed_lof_hc_pli_filt_kgen_ddr.df <- output_hc_pli.df
gt_lof_filt_kgen_ddr.mx <- output.mx
gt_lof_hc_filt_kgen_ddr.mx <- output_hc.mx
gt_lof_hc_pli_filt_kgen_ddr.mx <- output_hc_pli.mx
...
save.image(paste(output_folder, "r01_kgen_ddr_lof_filtered.RData", sep="/"))
