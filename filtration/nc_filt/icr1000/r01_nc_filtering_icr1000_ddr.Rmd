---
title: "r01_nc_filtering_icr1000_ddr"
...
input.mx <- gt_af_filt_icr1000_ddr.mx
...
# Compare filtered fixed column dataframe and genotype matrix
output_hc_pli.df[1:15,1:5]
output_hc_pli.mx[1:15,1:2]
...
fixed_nc_hc_pli_filt_icr1000_ddr.df <- output_hc_pli.df
gt_nc_filt_icr1000_ddr.mx <- output.mx
gt_nc_hc_filt_icr1000_ddr.mx <- output_hc.mx
gt_nc_hc_pli_filt_icr1000_ddr.mx <- output_hc_pli.mx
...
save.image(paste(output_folder, "r01_icr1000_ddr_nc_filtered.RData", sep="/"))
