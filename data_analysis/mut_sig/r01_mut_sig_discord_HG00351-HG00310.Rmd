---
title: "r01_mut_sig_discord_HG00351-HG00310"
...
Individual: Present in HG00351 (FIN; DDR-) but not in HG00310 (FIN; DDR+)  
...
# Set sample name
sample_name <- c("HG00351-HG0310")

# Set and load working VCF file
vcf_file="~/results/data_analysis/gt_individuals/kgen/discordant/s01_HG00351-HG00310_discordant.vcf"
...
# Check dataframe
dim(required_fixed.df)   # 1,367,054 x 5
...
# Check dataframe
dim(required_fixed.df) # 1,206,195 x 5
...
save.image("~/results/data_analysis/mut_sig/r01_mut_sig_discord_HG00351-HG00310.Rdata")
