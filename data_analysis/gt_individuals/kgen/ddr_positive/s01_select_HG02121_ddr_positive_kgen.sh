#!/bin/bash
# s01_select_HG02121_ddr_positive_kgen.sh
...
# Selection of DDR Positive 'Test' Individual (HG02121; KHV (EAS)) from 1000 Genome Project (Genotype VCF Files)
