#!/bin/bash
# s01_select_HG00310_ddr_positive_kgen.sh
...
# Selection of DDR Positive 'Test' Individual (HG00310; FIN (EUR)) from 1000 Genome Project (Genotype VCF Files)
