...
last updated: Alexey Larionov, 11May2018  
...
# Working folder
base_folder="/Users/alexey/Documents/dg/m05_May_wk2/select_coding_regions"
setwd(base_folder)
...
# read CCDS data
file_name <- paste(base_folder,"data/CCDS_15/CCDS.current.txt",sep="/")
...
# Read DDR genes
file_name <- paste(base_folder,"data/dna_repair_gene_coordinates_grch37_13.txt",sep="/")
...
# Read OR genes
file_name <- paste(base_folder,"data/or_gene_cooridinates_grch37_13.txt",sep="/")
...
# Explore genes lists, their intersects and dfferences
OR_genes <- or_genes.df$ene.name # "ene.name" column ...
length(OR_genes)
...
all_or_genes <- unique(or_genes.df$ene.name)
length(all_or_genes)
...
save.image(paste(base_folder, "data/calculate_CCDS_length.RData", sep="/"))
