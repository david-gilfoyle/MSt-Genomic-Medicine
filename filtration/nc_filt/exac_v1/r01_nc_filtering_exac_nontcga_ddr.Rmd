...
rm(fixed_af_filt_exac_tcga_ddr.df)
...
fixed_nc_hc_pli_filt_exac_nontcga_ddr.df <- output_hc_pli.df
...
save.image(paste(output_folder, "r01_exac_nontcga_ddr_nc_filtered.RData", sep="/"))
