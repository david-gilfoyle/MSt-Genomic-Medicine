---
title: "r01_mut_sig_ddr_neg_HG02067"
...
Individual: HG02067 (KHV) - Control
...
# Set sample name
sample_name <- c("HG02067")

# Set and load working VCF file
vcf_file="~/results/data_analysis/gt_individuals/kgen/ddr_control/HG02067/s01_HG02067_ddr_control_kgen_merged_raw.vcf.gz"
...
# Check dataframe
dim(required_fixed.df)   # 4,222,920 x 5
...
# Check dataframe
dim(required_fixed.df) # 3,653,482 x 5
...
save.image("~/results/data_analysis/mut_sig/r01_mut_sig_ddr_neg_HG02067.Rdata")
