---
title: "r01_mut_sig_discord_NA19315-HG00351"
...
Individual: Present in NA19315 (LWK; DDR-) but not in HG00351 (FIN; DDR-)  
...
# Set sample name
sample_name <- c("NA19315-HG00351")

# Set and load working VCF file
vcf_file="~/results/data_analysis/gt_individuals/kgen/discordant/s01_NA19315-HG00351_discordant.vcf"
...
# Check dataframe
dim(required_fixed.df)   # 2,570,821 x 5
...
# Check dataframe
dim(required_fixed.df) # 2,286,081 x 5
...
save.image("~/results/data_analysis/mut_sig/r01_mut_sig_discord_NA19315-HG00351.Rdata")
