#!/bin/bash
# s01_vep_annotation_ddr_kgen.sh

# Started: Alexey Larionov 18Mar2018
# Last updated: David Gilfoyle 20Apr2018

# Use:
# ./s01_vep_annotation_ddr_kgen.sh &> s01_vep_annotation_ddr_kgen.log

# VEP Annotation - 1000 Genome Project (DNA Repair Gene Selection) 

# Stop at runtime errors
set -e

# Start message
echo "Started s01_vep_annotation_ddr_kgen.sh"
date
echo ""
...
# File names
working_folder="${base_folder}/results/preprocessed/kgen"
results_folder="${base_folder}/results/annotated/kgen"

raw_vcf="${working_folder}/s01_ddr_kgen_split_fixed.vcf"
vep_vcf="${results_folder}/s01_ddr_kgen_vep_annotated.vcf"
vep_stats="${results_folder}/s01_ddr_kgen_vep_annotated.html"
vep_script_log="${results_folder}/s01_ddr_kgen_vep_annotated.log"
...
# Completion message
echo ""
echo "Completed s01_vep_annotation_ddr_kgen.sh"
date
echo ""
