#!/bin/bash
# s01_vep_annotation_ddr_icr1000.sh

# Started: Alexey Larionov 18Mar2018
# Last updated: David Gilfoyle 12Apr2018

# Use:
# ./s01_vep_annotation_ddr_icr1000.sh &> s01_vep_annotation_ddr_icr1000.log

# VEP Annotation - ICR1000 Dataset (DNA Repair Gene Selection) 

# Stop at runtime errors
set -e

# Start message
echo "Started s01_vep_annotation_ddr_icr1000.sh"
date
echo ""
...
# File names
working_folder="${base_folder}/results/preprocessed/icr1000"
results_folder="${base_folder}/results/annotated/icr1000"

raw_vcf="${working_folder}/s01_ddr_icr1000_split.vcf"
vep_vcf="${results_folder}/s01_ddr_icr1000_vep_annotated.vcf"
vep_stats="${results_folder}/s01_ddr_icr1000_vep_annotated.html"
vep_script_log="${results_folder}/s01_ddr_icr1000_vep_annotated.log"
...
# Completion message
echo ""
echo "Completed s01_vep_annotation_ddr_icr1000.sh"
date
echo ""
