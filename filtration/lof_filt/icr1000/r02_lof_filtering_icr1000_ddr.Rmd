---
title: "r02_lof_filtering_icr1000_ddr"
...
fixed_lof_filt_icr1000_ddr.df <- output.df
fixed_lof_hc_filt_icr1000_ddr.df <- output_hc.df
fixed_lof_hc_pli_filt_icr1000_ddr.df <- output_hc_pli.df
gt_lof_filt_icr1000_ddr.mx <- output.mx
gt_lof_hc_filt_icr1000_ddr.mx <- output_hc.mx
gt_lof_hc_pli_filt_icr1000_ddr.mx <- output_hc_pli.mx
...
save.image(paste(output_folder, "r02_icr1000_ddr_lof_filtered.RData", sep="/"))
