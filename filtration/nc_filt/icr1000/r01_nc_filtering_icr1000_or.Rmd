---
title: "r01_nc_filtering_icr1000_or"
...
# Compare filtered fixed column dataframe and genotype matrix
output_hc.df[1:14,1:5]
output_hc.mx[1:14,1:2]

```

# additional_filtering_exac_pli

Deleterious nonclinical variants in a single allele are expected to have a greater impact in loss intolerant genes (ExAC pLI >= 0.9) 
...
fixed_nc_filt_icr1000_or.df <- output.df
fixed_nc_hc_filt_icr1000_or.df <- output_hc.df
fixed_nc_hc_pli_filt_icr1000_or.df <- output_hc_pli.df
gt_nc_filt_icr1000_or.mx <- output.mx
gt_nc_hc_filt_icr1000_or.mx <- output_hc.mx
gt_nc_hc_pli_filt_icr1000_or.mx <- output_hc_pli.mx
...
save.image(paste(output_folder, "r01_icr1000_or_nc_filtered.RData", sep="/"))
