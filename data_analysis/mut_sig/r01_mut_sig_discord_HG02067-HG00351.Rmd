---
title: "r01_mut_sig_discord_HG02067-HG00351"
...
Individual: Present in HG02067 (KHV; DDR-) but not in HG00351 (FIN; DDR-)  
...
# Set sample name
sample_name <- c("HG02067-HG00351")

# Set and load working VCF file
vcf_file="~/results/data_analysis/gt_individuals/kgen/discordant/s01_HG02067-HG00351_discordant.vcf"
...
# Check dataframe
dim(required_fixed.df)   # 1,540,540 x 5
...
# Check dataframe
dim(required_fixed.df) # 1,355,437 x 5
...
save.image("~/results/data_analysis/mut_sig/r01_mut_sig_discord_HG02067-HG00351.Rdata")
