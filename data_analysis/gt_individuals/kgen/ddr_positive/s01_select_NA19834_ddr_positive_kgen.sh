#!/bin/bash
# s01_select_NA19834_ddr_positive_kgen.sh
...
# Selection of DDR Positive 'Test' Individual (NA19834; ASW (AFR)) from 1000 Genome Project (Genotype VCF Files)
