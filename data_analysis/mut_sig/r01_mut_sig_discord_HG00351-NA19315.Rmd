---
title: "r01_mut_sig_discord_HG00351-NA19315"
...
Individual: Present in HG00351 (FIN; DDR-) but not in NA19315 (LWK; DDR-)  
...
# Set sample name
sample_name <- c("HG00351-NA19315")

# Set and load working VCF file
vcf_file="~/results/data_analysis/gt_individuals/kgen/discordant/s01_HG00351-NA19315_discordant.vcf"
...
# Check dataframe
dim(required_fixed.df)   # 1,609,612 x 5
...
# Check dataframe
dim(required_fixed.df) # 1,422,846 x 5
...
save.image("~/results/data_analysis/mut_sig/r01_mut_sig_discord_HG00351-NA19315.Rdata")
