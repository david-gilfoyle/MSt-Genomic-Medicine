...
# s01_preprocessing_qc_exac_ddr.sh
# ExAC (DNA Repair Genes) Preprocessed File Quality Control

# Created: David Gilfoyle 22 Apr 2018
# Last Updated: David Gilfoyle 22 Apr 2018

# Use:
# ./s01_preprocessing_qc_exac_ddr.sh &> s01_preprocessing_qc_exac_ddr.log

# Stop at runtime errors
set -e

# Start message
echo "Starting Preprocessed ExAC File Quality Control (DNA Repair Genes)"
date
echo ""

# Tools, resources, files
base_folder="/home/ec2-user"
full_file="${base_folder}/resources/exac_v1/ExAC.r1.sites.vep.vcf.gz"
raw_file="${base_folder}/results/preprocessed/exac_v1/s01_ddr_exac_raw.vcf"
ma_file="${base_folder}/results/preprocessed/exac_v1/s01_ddr_exac_ma.vcf"
fma_file="${base_folder}/results/preprocessed/exac_v1/s01_ddr_exac_fma.vcf"
clean_file="${base_folder}/results/preprocessed/exac_v1/s01_ddr_exac_clean.vcf"
split_file="${base_folder}/results/preprocessed/exac_v1/s01_ddr_exac_split.vcf"

vcf_stats_folder="${base_folder}/results/preprocessed/vcf_stats/exac_full_ddr/"
vcf_stats1="${base_folder}/results/preprocessed/vcf_stats/exac_full_ddr/exac_full_downloaded_vcfstats.txt"
vcf_stats2="${base_folder}/results/preprocessed/vcf_stats/exac_full_ddr/exac_full_ddr_split_vcfstats.txt"
...
# End message
echo "Finishing Preprocessed ExAC File Quality Control (DNA Repair Genes)"
date
echo ""
