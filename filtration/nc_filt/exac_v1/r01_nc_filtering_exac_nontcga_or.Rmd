---
title: "r01_nc_filtering_exac_nontcga_or"
...
fixed_nc_filt_exac_nontcga_or.df <- output.df
fixed_nc_hc_filt_exac_nontcga_or.df <- output_hc.df
fixed_nc_hc_pli_filt_exac_nontcga_or.df <- output_hc_pli.df
...
save.image(paste(output_folder, "r01_exac_nontcga_or_nc_filtered.RData", sep="/"))
