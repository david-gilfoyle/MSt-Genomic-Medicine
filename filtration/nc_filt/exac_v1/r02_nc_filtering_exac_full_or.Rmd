---
title: "r02_nc_filtering_exac_full_or"
...
Variant filtering of AF filtered dataset to select non-coding (Consequence) and high confidence (HC) non-coding (FATHMM_MKL_NC > 0.92 and CADD_PHRED > 15)  
Dataset: ExAC (full)  
...
save.image(paste(output_folder, "r02_exac_full_or_nc_filtered.RData", sep="/"))
