---
title: "r01_mut_sig_discord_HG00351-HG00179"
...
Individual: Present in HG00351 (FIN; DDR-) but not in HG00179 (FIN; DDR-)  
...
# Set sample name
sample_name <- c("HG00351-HG0179")

# Set and load working VCF file
vcf_file="~/results/data_analysis/gt_individuals/kgen/discordant/s01_HG00351-HG00179_discordant.vcf"
...
# Check dataframe
dim(required_fixed.df)   # 1,331,474 x 5
...
# Check dataframe
dim(required_fixed.df) # 1,174,766 x 5
...
save.image("~/results/data_analysis/mut_sig/r01_mut_sig_discord_HG00310-HG00179.Rdata")
