#!/bin/bash
# s01_split_multiallelics_kgen_or_bcftools.sh

# Started: Alexey Larionov 18Mar2018
# Last updated: David Gilfoyle 20Apr2018

# Use:
# ./s01_split_multiallelics_kgen_or_bcftools.sh &> s01_split_multiallelics_kgen_or_bcftools.log

# Splitting Multiallelic Variants in Olfactory Receptor Genes from 1000 Genome Project
...
# Start message
echo "Started s01_split_multiallelics_kgen_or_bcftools.sh"
date
echo ""
...
fma_vcf="${base_folder}/results/preprocessed/kgen/s01_or_kgen_fma.vcf"

split_vcf="${base_folder}/results/preprocessed/kgen/s01_or_kgen_split.vcf"
...
# Completion mesage
echo ""
echo "Completed s01_split_multiallelics_kgen_or_bcftools.sh"
date
