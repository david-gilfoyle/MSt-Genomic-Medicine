#!/bin/bash
# s01_sort_merge_HG02977_ddr_positive_kgen.sh

# Started: David Gilfoyle 27May2018
# Last updated: David Gilfoyle 28May2018

# Use:
# ./s01_sort_merge_HG02977_ddr_positive_kgen.sh &> s01_sort_merge_HG02977_ddr_positive_kgen.log

# Sorting and Remerging of VCF Files for Selected DDR Positive Individuals from 1000 Genome Project (Genotype VCF Files)

# The initial merging of VCF files from positive subject HG02977 failed during chromosome 7
...
# Starting script
echo "Starting s01_sort_merge_HG02977_ddr_positive_kgen.sh"
date
echo ""
...
# Finishing script
echo "Completed s01_sort_merge_HG02977_ddr_positive_kgen.sh"
date
echo ""
