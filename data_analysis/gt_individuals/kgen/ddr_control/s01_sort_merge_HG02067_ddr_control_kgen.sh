#!/bin/bash
# s01_sort_merge_HG02067_ddr_control_kgen.sh

# Started: David Gilfoyle 27May2018
# Last updated: David Gilfoyle 27May2018

# Use:
# ./s01_sort_merge_HG02067_ddr_control_kgen.sh &> s01_sort_merge_HG02067_ddr_control_kgen.log

# Sorting and Remerging of VCF Files for Selected DDR Control Individuals from 1000 Genome Project (Genotype VCF Files)

# The initial merging of VCF files from control subject HG02067 failed during chromosome 14
...
# Starting script
echo "Starting s01_sort_merge_HG02067_ddr_control_kgen.sh"
date
echo ""
...
java -jar "${picard_tool}"/picard.jar SortVcf \
	...
	O="${input_folder}"/s01_${individual_id}_ddr_control_kgen_chr14_raw_sorted.vcf
...
I="${input_folder}"/s01_${individual_id}_ddr_control_kgen_chr14_raw_sorted.vcf \
...
# Finishing script
echo "Completed s01_sort_merge_HG02067_ddr_control_kgen.sh"
date
echo ""
