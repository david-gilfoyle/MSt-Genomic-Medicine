#!/bin/bash
# s01_sort_merge_HG00351_ddr_control_kgen.sh

# Started: David Gilfoyle 27May2018
# Last updated: David Gilfoyle 27May2018

# Use:
# ./s01_sort_merge_HG00351_ddr_control_kgen.sh &> s01_sort_merge_HG00351_ddr_control_kgen.log

# Sorting and Remerging of VCF Files for Selected DDR Control Individuals from 1000 Genome Project (Genotype VCF Files)

# The initial merging of VCF files from control subject HG00351 failed during chromosome 4
# This script sorts the chromosome 4 VCF file before remerging
...
# Starting script
echo "Starting s01_sort_merge_HG00351_ddr_control_kgen.sh"
date
echo ""
...
echo ""
echo "Sorting individual genotype VCF file (chromosome 4) from 1000 Genome Project"
date

java -jar "${picard_tool}"/picard.jar SortVcf \
	I="${input_folder}"/s01_${individual_id}_ddr_control_kgen_chr4_raw.vcf \
	O="${input_folder}"/s01_${individual_id}_ddr_control_kgen_chr4_raw_sorted.vcf

# Merging 1000 Genome Individual Genotype VCF files
echo ""
echo "Merging DDR control individual genotype VCF files (including sorted chromosome 4) from 1000 Genome Project"
date
...
I="${input_folder}"/s01_${individual_id}_ddr_control_kgen_chr4_raw_sorted.vcf \
...
# Finishing script
echo "Completed s01_sort_merge_HG00351_ddr_control_kgen.sh"
date
echo ""
