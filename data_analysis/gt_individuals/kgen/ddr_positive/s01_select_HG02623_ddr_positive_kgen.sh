#!/bin/bash
# s01_select_HG02623_ddr_positive_kgen.sh
...
# Selection of DDR Positive 'Test' Individual (HG02623; GWD (AFR)) from 1000 Genome Project (Genotype VCF Files)
