#!/bin/bash
# s01_flag_multiallelics_kgen_ddr_gatk3.sh

# Started: Alexey Larionov 15Mar2018
# Last updated: David Gilfoyle 20Apr2018

# Use:
# ./s01_flag_multiallelics_kgen_ddr_gatk3.sh &> s01_flag_multiallelics_kgen_ddr_gatk3.log

# Flagging of Multiallelic Variants in DNA Repair Genes from 1000 Genome Project 
...
# Start message
echo "Started s01_flag_multiallelics_kgen_ddr_gatk3.sh"
date
echo ""
...
ddr_or_kgen_raw_vcf="${base_folder}/results/preprocessed/kgen/s01_ddr_kgen_merged_raw.vcf.gz"

# ma for "multi-allelic"
ddr_or_kgen_ma_vcf="${base_folder}/results/preprocessed/kgen/s01_ddr_kgen_ma.vcf"
ddr_or_kgen_ma_log="${base_folder}/results/preprocessed/kgen/s01_ddr_kgen_ma.log"

# "fma" for "flag multi-alelic"
ddr_or_kgen_fma_vcf="${base_folder}/results/preprocessed/kgen/s01_ddr_kgen_fma.vcf"
ddr_or_kgen_fma_log="${base_folder}/results/preprocessed/kgen/s01_ddr_kgen_fma.log"
...
# Completion mesage
echo ""
echo "Completed s01_flag_multiallelics_kgen_ddr_gatk3.sh"
date
