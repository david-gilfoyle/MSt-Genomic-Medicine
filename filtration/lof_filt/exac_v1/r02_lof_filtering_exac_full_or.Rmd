---
title: "r02_lof_filtering_exac_full_or"
...
class(input.df$LoF)
input.df$LoF[1200:1220] # range updated to show presence of HC
...
output_hc.df$LoF[120:130] # range updated to show presence of NA
...
fixed_lof_filt_exac_full_or.df <- output.df
fixed_lof_hc_filt_exac_full_or.df <- output_hc.df
fixed_lof_hc_pli_filt_exac_full_or.df <- output_hc_pli.df
...
save.image(paste(output_folder, "r02_exac_full_or_lof_filtered.RData", sep="/"))
