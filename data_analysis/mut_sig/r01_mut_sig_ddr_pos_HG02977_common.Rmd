---
title: "r01_mut_sig_ddr_pos_HG02977_common"
...
Individual: HG02977 (ESN) - DDR deficient (homozygous SLX1A)
...
# Set sample name
sample_name <- c("HG02977_common variants")

# Set and load working VCF file
vcf_file="~/results/data_analysis/gt_individuals/kgen/ddr_positive/HG02977/s01_HG02977_ddr_positive_kgen_merged_raw.vcf.gz"
...
# Check dataframe
dim(required_fixed.df)   # 4,210,031 x 5
...
# Check dataframe
dim(required_fixed.df) # 3,677,671 x 5
...
save.image("~/results/data_analysis/mut_sig/r01_mut_sig_ddr_pos_HG02977_common.Rdata")
