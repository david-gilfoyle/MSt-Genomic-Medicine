---
title: "r01_mut_sig_ddr_neg_NA19315_common"
...
Individual: NA19315 (LWK) - Control
...
# Set sample name
sample_name <- c("NA19315_common variants")

# Set and load working VCF file
vcf_file="~/results/data_analysis/gt_individuals/kgen/ddr_control/NA19315/s01_NA19315_ddr_control_kgen_merged_raw.vcf.gz"
...
# Check dataframe
dim(required_fixed.df)   # 4,198,561 x 5
...
# Check dataframe
dim(required_fixed.df) # 3,664,483 x 5
...
save.image("~/results/data_analysis/mut_sig/r01_mut_sig_ddr_neg_NA19315_common.Rdata")
