---
title: "r02_mis_filtering_kgen_or"
...
load(paste(input_folder, "r01_kgen_or_af_filtered.RData", sep="/"))

# Setup script input dataframe naming
input.df <- fixed_af_filt_kgen_or.df
rm(fixed_af_filt_kgen_or.df)
input.mx <- gt_af_filt_kgen_or.mx
...
# Compare filtered fixed column dataframe and genotype matrix
output_hc.df[1:3,1:5]
output_hc.mx[1:3,1:2]
...
fixed_mis_filt_kgen_or.df <- output.df
fixed_mis_hc_filt_kgen_or.df <- output_hc.df
fixed_mis_hc_pli_filt_kgen_or.df <- output_hc_pli.df
gt_mis_filt_kgen_or.mx <- output.mx
gt_mis_hc_filt_kgen_or.mx <- output_hc.mx
gt_mis_hc_pli_filt_kgen_or.mx <- output_hc_pli.mx
...
save.image(paste(output_folder, "r02_kgen_or_mis_filtered.RData", sep="/"))
