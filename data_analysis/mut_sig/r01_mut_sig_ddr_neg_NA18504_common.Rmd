---
title: "r01_mut_sig_ddr_neg_NA18504_common"
...
Individual: NA18504 (YRI) - Control
...
# Set sample name
sample_name <- c("NA18504_common variants")

# Set and load working VCF file
vcf_file="~/results/data_analysis/gt_individuals/kgen/ddr_control/NA18504/s01_NA18504_ddr_control_kgen_merged_raw.vcf.gz"
...
# Check dataframe
dim(required_fixed.df)   # 4,200,237 x 5
...
# Check dataframe
dim(required_fixed.df) # 3,668,285 x 5
...
save.image("~/results/data_analysis/mut_sig/r01_mut_sig_ddr_neg_NA18504_common.Rdata")
