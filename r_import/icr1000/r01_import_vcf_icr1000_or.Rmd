---
title: "r01_import_vcf_icr1000_or"
...
vcf_file <- paste(input_folder,"s01_or_icr1000_vep_annotated.vcf",sep="/")
...
fixed_icr1000_or.df <- as.data.frame(meta_fix$fix)
dim(fixed_icr1000_or.df)
fixed_icr1000_or.df[1:20,1:10]

# extract genotypes matrix 
gt_icr1000_or.mx <- extract.gt(vcfr) # original numeric codes: 0/1, 1/1 etc
NA -> gt_icr1000_or.mx[gt_icr1000_or.mx == "."] # assign NA to '.'
dim(gt_icr1000_or.mx)
gt_icr1000_or.mx[1:5,1:3]

# extract GQ matrix 
gq_icr1000_or.mx <- extract.gt(vcfr, element = "GQ", as.numeric=T)
dim(gq_icr1000_or.mx)
gq_icr1000_or.mx[1:5,1:3]
...
fixed_icr1000_or.df <- separate_(fixed_icr1000_or.df, "CSQ", vep_fields, sep="\\|") 
...
NA -> fixed_icr1000_or.df[fixed_icr1000_or.df == ""] 
dim(fixed_icr1000_or.df)
fixed_icr1000_or.df[1:20,80:85]
# Clean-up
rm(vep_fields)
...
save.image(paste(output_folder, "r01_import_vcf_icr1000_or.RData", sep="/"))
