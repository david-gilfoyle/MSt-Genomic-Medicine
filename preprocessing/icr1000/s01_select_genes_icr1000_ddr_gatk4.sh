#!/bin/bash
# s01_select_genes_icr1000_ddr_gatk4.sh

# Started: Alexey Larionov 15Mar2018
# Last updated: David Gilfoyle 11Apr2018

# Use:
# ./s01_select_genes_icr1000_ddr_gatk4.sh &> s01_select_genes_icr1000_ddr_gatk4.log

# Selection of DNA Repair Genes from ICR1000 
...
# Start message
echo "Started s01_select_genes_icr1000_ddr_gatk4.sh"
date
echo ""
...
ddr_or_icr_raw_log="${base_folder}/results/preprocessed/icr1000/s01_ddr_icr1000_raw.log"

# Select DNA Repair gene variants from ICR1000
echo "Selecting DDR gene variants from ICR1000 ..."
...
# Completion mesage
echo ""
echo "Completed s01_select_genes_icr1000_ddr_gatk4.sh"
date
