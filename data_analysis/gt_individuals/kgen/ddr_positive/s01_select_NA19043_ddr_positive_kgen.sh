#!/bin/bash
# s01_select_NA19043_ddr_positive_kgen.sh
...
# Selection of DDR Positive 'Test' Individual (NA19043; LWK (AFR)) from 1000 Genome Project (Genotype VCF Files)
