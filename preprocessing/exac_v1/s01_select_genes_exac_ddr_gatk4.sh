#!/bin/bash
# s01_select_genes_exac_ddr_gatk4.sh

# Started: Alexey Larionov 15Mar2018
# Last updated: David Gilfoyle 01Apr2018

# Use:
# ./s01_select_genes_exac_ddr_gatk4.sh &> s01_select_genes_exac_ddr_gatk4.log

# Selection of DNA Repair Genes from ExAC release 1 (full dataset) 
...
# Start message
echo "Started s01_select_genes_exac_ddr_gatk4.sh"
date
echo ""
...
ddr_or_exac_raw_log="${base_folder}/results/preprocessed/exac_v1/s01_ddr_exac_raw.log"

# Select DNA Repair gene variants from ExAC
echo "Selecting DDR gene variants from ExAC (full dataset) ..."
...
# Completion mesage
echo ""
echo "Completed s01_select_genes_exac_ddr_gatk4.sh"
date
