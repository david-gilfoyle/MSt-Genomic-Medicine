---
title: "r01_mut_sig_ddr_pos_HG00179_common"
...
Individual: HG00179 (FIN) - Control
...
# Set sample name
sample_name <- c("HG00179_common variants")

# Set and load working VCF file
vcf_file="~/results/data_analysis/gt_individuals/kgen/ddr_control/HG00179/s01_HG00179_ddr_control_kgen_merged_raw.vcf.gz"
...
# Check dataframe
dim(required_fixed.df)   # 3,790,188 x 5
...
# Check dataframe
dim(required_fixed.df) # 3,298,531 x 5
...
save.image("~/results/data_analysis/mut_sig/r01_mut_sig_ddr_neg_HG00179_common.Rdata")
