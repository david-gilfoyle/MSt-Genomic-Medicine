#!/bin/bash
# s01_flag_multiallelics_icr1000_or_gatk3.sh

# Started: Alexey Larionov 15Mar2018
# Last updated: David Gilfoyle 11Apr2018

# Use:
# ./s01_flag_multiallelics_icr1000_or_gatk3.sh &> s01_flag_multiallelics_icr1000_or_gatk3.log

# Flagging of Multiallelic Variants in Olfactory Receptor Genes from ICR1000
...
# Start message
echo "Started s01_flag_multiallelics_icr1000_or_gatk3.sh"
date
echo ""
...
ddr_or_icr_ma_vcf="${base_folder}/results/preprocessed/icr1000/s01_or_icr1000_ma.vcf"
ddr_or_icr_ma_log="${base_folder}/results/preprocessed/icr1000/s01_or_icr1000_ma.log"

# "fma" for "flag multi-alelic"
ddr_or_icr_fma_vcf="${base_folder}/results/preprocessed/icr1000/s01_or_icr1000_fma.vcf"
ddr_or_icr_fma_log="${base_folder}/results/preprocessed/icr1000/s01_or_icr1000_fma.log"
...
# Completion mesage
echo ""
echo "Completed s01_flag_multiallelics_icr_or_gatk3.sh"
date
