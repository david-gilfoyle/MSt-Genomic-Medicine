---
title: "r02_reg_filtering_kgen_ddr"
...
Variant filtering of AF filtered dataset to select non-clinical (Consequence) and high confidence (HC) non-clinical (FATHMM_MKL_NC > 0.92 and CADD_PHRED > 20)  
...
save.image(paste(output_folder, "r02_kgen_ddr_nc_filtered.RData", sep="/"))
