#!/bin/bash
# s01_fix_headers_kgen_or_gatk4.sh

# Started: David Gilfoyle 20Apr2018
# Last updated: David Gilfoyle 20Apr2018

# Use:
# ./s01_fix_headers_kgen_or_gatk4.sh &> s01_fix_headers_kgen_or_gatk4.log
...
# Starting script
echo "Starting s01_fix_headers_kgen_or_gatk4.sh"
date
echo ""
...
kgen_vcf="${base_folder}/results/preprocessed/kgen/s01_or_kgen_split.vcf"
kgen_fixed_vcf="${base_folder}/results/preprocessed/kgen/s01_or_kgen_split_fixed.vcf"
...
# Finishing script
echo "Finishing s01_fix_headers_kgen_or_gatk4.sh"
date
echo ""
