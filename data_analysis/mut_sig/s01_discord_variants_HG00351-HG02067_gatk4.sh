#!/bin/bash
# s01_discord_variants_HG00351-HG02067_gatk4.sh

# Started: David Gilfoyle 04Jul2018
# Last updated: David Gilfoyle 04Jul2018

# Use:
# ./s01_discord_variants_HG00351-HG02067_gatk4.sh &> s01_discord_variants_HG00351-HG02067_gatk4.log

# Selection of Discoradant Variants from 1000 Genome Project Individuals HG00351 (FIN; DDR-) and HG02067 (KHV; DDR-)
# Selected variants are present in Individual HG00351 but not in HG02067 
...
# Start message
echo "Started s01_discord_variants_HG00351-HG02067_gatk4.sh"
date
echo ""
...
vcf2="${base_folder}/results/data_analysis/gt_individuals/kgen/ddr_control/HG02067/s01_HG02067_ddr_control_kgen_merged_raw.vcf.gz"

output_vcf="${base_folder}/results/data_analysis/gt_individuals/kgen/discordant/s01_HG00351-HG02067_discordant.vcf"
output_log="${base_folder}/results/data_analysis/gt_individuals/kgen/discordant/s01_HG00351-HG02067_discordant.log"
...
# Completion mesage
echo ""
echo "Completed s01_discord_variants_HG00351-HG02067_gatk4.sh"
date
