---
title: "r02_mis_filtering_exac_nontcga_or"
...
load(paste(input_folder, "r01_exac_nontcga_or_af_filtered.RData", sep="/"))

# Setup script input dataframe naming
input.df <- fixed_af_filt_exac_nontcga_or.df
rm(fixed_af_filt_exac_nontcga_or.df)
...
fixed_mis_filt_exac_nontcga_or.df <- output.df
fixed_mis_hc_filt_exac_nontcga_or.df <- output_hc.df
fixed_mis_hc_pli_filt_exac_nontcga_or.df <- output_hc_pli.df

# Clean-up
rm(input.df, output.df, output_hc.df, output_hc_pli.df, or_genes, removed_variant.df)
...
save.image(paste(output_folder, "r02_exac_nontcga_or_mis_filtered.RData", sep="/"))
