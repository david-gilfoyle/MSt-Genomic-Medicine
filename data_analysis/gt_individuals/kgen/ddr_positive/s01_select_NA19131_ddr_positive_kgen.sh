#!/bin/bash
# s01_select_NA19131_ddr_positive_kgen.sh
...
# Selection of DDR Positive 'Test' Individual (NA19131; YRI (AFR)) from 1000 Genome Project (Genotype VCF Files)
