#!/bin/bash
# s01_discord_variants_NA19315-HG00351_gatk4.sh

# Started: David Gilfoyle 04Jul2018
# Last updated: David Gilfoyle 04Jul2018

# Use:
# ./s01_discord_variants_NA19315-HG00351_gatk4.sh &> s01_discord_variants_NA19315-HG00351_gatk4.log

# Selection of Discoradant Variants from 1000 Genome Project Individuals NA19315 (LWK; DDR-) and HG00351 (FIN; DDR-) 
# Selected variants are present in Individual NA19315 but not in HG00351 
...
# Start message
echo "Started s01_discord_variants_NA19315-HG00351_gatk4.sh"
date
echo ""
...
vcf2="${base_folder}/results/data_analysis/gt_individuals/kgen/ddr_control/NA19315/s01_NA19315_ddr_control_kgen_merged_raw.vcf.gz"

output_vcf="${base_folder}/results/data_analysis/gt_individuals/kgen/discordant/s01_NA19315-HG00351_discordant.vcf"
output_log="${base_folder}/results/data_analysis/gt_individuals/kgen/discordant/s01_NA19315-HG00351_discordant.log"
...
# Completion mesage
echo ""
echo "Completed s01_discord_variants_NA19315-HG00351_gatk4.sh"
date
