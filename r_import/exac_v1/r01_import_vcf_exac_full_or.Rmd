---
title: "r01_import_vcf_exac_full_or"
...
vcf_file <- paste(input_folder,"s01_or_exac_vep_annotated.vcf",sep="/")
...
fixed_exac_full_or.df <- as.data.frame(meta_fix$fix)
...
fixed_exac_full_or.df <- separate_(fixed_exac_full_or.df, "CSQ", vep_fields, sep="\\|") 
...
NA -> fixed_exac_full_or.df[fixed_exac_full_or.df == ""]
dim(fixed_exac_full_or.df)
fixed_exac_full_or.df[1:20,140:145]
...
save.image(paste(output_folder, "r01_import_vcf_exac_full_or.RData", sep="/"))
