#!/bin/bash
# s01_select_HG01998_ddr_positive_kgen.sh

# Started: David Gilfoyle 23May2018
# Last updated: David Gilfoyle 27May2018

# Use:
# ./s01_select_HG01998_ddr_positive_kgen.sh &> s01_select_HG01198_ddr_positive_kgen.log

# Selection of DDR Positive 'Test' Individual (HG01198; PUR (AMR)) from 1000 Genome Project (Genotype VCF Files)
