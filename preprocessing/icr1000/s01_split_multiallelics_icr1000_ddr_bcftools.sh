#!/bin/bash
# s01_split_multiallelics_icr1000_ddr_bcftools.sh

# Started: Alexey Larionov 18Mar2018
# Last updated: David Gilfoyle 12Apr2018

# Use:
# ./s01_split_multiallelics_icr1000_ddr_bcftools.sh &> s01_split_multiallelics_icr1000_ddr_bcftools.log

# Splitting Multiallelic Variants in DNA Repair Genes from ICR1000
...
# Start message
echo "Started s01_split_multiallelics_icr1000_ddr_bcftools.sh"
date
echo ""
...
fma_vcf="${base_folder}/results/preprocessed/icr1000/s01_ddr_icr1000_fma.vcf"

split_vcf="${base_folder}/results/preprocessed/icr1000/s01_ddr_icr1000_split.vcf"
...
# Completion mesage
echo ""
echo "Completed s01_split_multiallelics_icr1000_ddr_bcftools.sh"
date
