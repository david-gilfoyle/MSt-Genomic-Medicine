---
title: "r02_lof_filtering_exac_nontcga_or"
...
fixed_lof_filt_exac_nontcga_or.df <- output.df
fixed_lof_hc_filt_exac_nontcga_or.df <- output_hc.df
fixed_lof_hc_pli_filt_exac_nontcga_or.df <- output_hc_pli.df
...
save.image(paste(output_folder, "r02_exac_nontcga_or_lof_filtered.RData", sep="/"))
