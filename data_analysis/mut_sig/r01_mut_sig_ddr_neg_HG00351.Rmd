---
title: "r01_mut_sig_ddr_neg_HG00351"
...
Individual: HG00351 (FIN) - Control
...
# Set sample name
sample_name <- c("HG00351")

# Set and load working VCF file
vcf_file="~/results/data_analysis/gt_individuals/kgen/ddr_control/HG00351/s01_HG00351_ddr_control_kgen_merged_raw.vcf.gz"
...
# Check dataframe
dim(required_fixed.df)   # 4,186,098 x 5
...
# Check dataframe
dim(required_fixed.df) # 3,626,382 x 5
...
save.image("~/results/data_analysis/mut_sig/r01_mut_sig_ddr_neg_HG00351.Rdata")
