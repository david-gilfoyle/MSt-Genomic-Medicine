#!/bin/bash
# s01_select_genes_exac_nontcga_or_gatk4.sh

# Started: Alexey Larionov 15Mar2018
# Last updated: David Gilfoyle 01Apr2018

# Use:
# ./s01_select_genes_exac_nontcga_or_gatk4.sh &> s01_select_genes_exac_nontcga_or_gatk4.log

# Selection of Olfactory Receptor Genes from ExAC release 1 (nonTCGA subset) 
...
# Start message
echo "Started s01_select_genes_exac_nontcga_or_gatk4.sh"
date
echo ""
...
ddr_or_exac_raw_log="${base_folder}/results/preprocessed/exac_v1/s01_or_exac_nontcga_raw.log"

# Select Olfactory Receptor gene variants from non-TCGA ExAC
echo "Selecting OR gene variants from non-TCGA ExAC ..."
...
# Completion mesage
echo ""
echo "Completed s01_select_genes_exac_nontcga_or_gatk4.sh"
date
